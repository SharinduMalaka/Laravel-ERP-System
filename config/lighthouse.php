...
'graphql_playground' => env('GRAPHQL_PLAYGROUND', true),
'debug' => env('GRAPHQL_DEBUG', true),
'default_field_resolver' => env('GRAPHQL_DEFAULTS', true),

'path' => env('GRAPHQL_PATH', '/graphql'),
'domain' => env('GRAPHQL_DOMAIN', 'localhost'),
'port' => env('GRAPHQL_PORT', 4000),
